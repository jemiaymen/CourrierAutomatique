...
@WebServlet("/ConfCourrier")
public class ConfCourrier extends MyServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IsLogin(request,response,"2","ConfAddCourrier");
	}
	...
	public String[] getCourrier(int uid){
		...
		String nbr ="0";
		try {
			List<Courrier> cs = em.createQuery("SELECT c FROM Courrier c WHERE c.userByChuid.id =" + uid + "AND c.etat=" + 0, Courrier.class).getResultList();
			if(cs != null){
